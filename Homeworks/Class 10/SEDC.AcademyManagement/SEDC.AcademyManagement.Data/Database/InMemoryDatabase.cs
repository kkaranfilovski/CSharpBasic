...
namespace SEDC.AcademyManagement.Data.Database
{
    public class InMemoryDatabase
    {
        ...
        public void InitDatabase()
        {
            ...
            {
                new Student(1, "Kristijan Karanfilovski", "krikar", "kiko123", Subjects[4], Subjects),
                new Student(2, "Ilija Mitev", "ilemit", "ile123", Subjects[4], Subjects),
                new Student(3, "Igor Nikoloski", "igonik", "tigre123", Subjects[4], Subjects),
                new Student(4, "Radmila Petrusevska", "radpet", "radmila123", Subjects[0], Subjects),
